        ...
        <div
          ...
          <div className="mb-8">
            <div className="relative inline-block">
              <div className="w-48 h-48 sm:w-56 sm:h-56 mx-auto rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-1 shadow-2xl">
                <div className="w-full h-full rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center text-6xl text-gray-500 dark:text-gray-400">
